...
-- Icon directory path
local icondir = awful.util.getdir("config") .. "theme/icons/audio/"
...
return function(s)
  ...
  local function create_device(name, node, sink)
    ...
    if sink == true then
      device:connect_signal(
        "button::press",
        function()
          awful.spawn.spawn(os.getenv("HOME").."/.config/awesome/widget/audio/vol.sh set_sink " .. node)
      ...
      device:connect_signal(
        "button::press",
        function()
          awful.spawn.spawn(os.getenv("HOME").."/.config/awesome/widget/audio/mic.sh set_source " .. node)
  ...
  local function get_mic_volume()
    awful.spawn.easy_async_with_shell(
      os.getenv("HOME").."/.config/awesome/widget/audio/mic.sh volume",
      function(stdout)
  ...
  local function get_mic_mute()
    awful.spawn.easy_async_with_shell(
      os.getenv("HOME").."/.config/awesome/widget/audio/mic.sh mute",
      function(stdout)
