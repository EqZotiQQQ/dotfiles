...
local function worker(args)
  ...
  local ICON_DIR = awful.util.getdir("config").."widgets/network_widgets/icons/"
  local yes_internet = wibox.widget {
    {
      widget = wibox.widget.imagebox,
      image = ICON_DIR.."icons8-wired-network-96.png",
      resize = false,
    },
  ...
  local no_internet = wibox.widget {
    {
      widget = wibox.widget.imagebox,
      image = ICON_DIR.."icons8-no-network-100.png",
      resize = false,
    },
    layout = wibox.container.margin(brightness_icon, 0, 0, 2)
  }
  -- d.notify_persistent(yes_internet)
  -- Settings
